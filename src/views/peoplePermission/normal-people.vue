  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="编辑" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          ...
          <el-button v-if="row.status!='deleted'" size="mini" type="text" :style="{color:'red'}"  @click="handleDelete(row,$index)">
            删除
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="是否为门店管理员：">
          <el-radio-group v-model="temp.type">
            <el-radio :label="3">是</el-radio>
            <el-radio :label="6">否</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="开通权限：" prop="title">
          <el-checkbox v-for="item in statusOptions" :label="item" :key="item">{{item}}</el-checkbox>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      statusOptions: ['拆车中心', '订单中心', '库存中心', '调拨中心'],
      showReviewer: false,
      temp: {
        id: undefined,
        importance: 1,
